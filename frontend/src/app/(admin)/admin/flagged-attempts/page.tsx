  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gradient-to-br from-green-500/5 to-emerald-500/5 rounded-xl shadow-sm border border-green-500/10">
          <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-3xl">✓</span>
          </div>
          <p className="text-green-700 font-semibold">No flagged attempts found</p>
        ...
        <div className="space-y-4">
          {attempts.map((attempt) => (
            <div
              key={attempt.id}
              className="bg-card p-6 rounded-xl shadow-sm border border-red-200 hover:shadow-md transition-all"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="bg-muted/50 p-3 rounded-lg">
                  ...
                  <div className={`text-xl font-bold ${
                    attempt.tabSwitchCount >= 3 ? 'text-red-600' : 'text-yellow-600'
                  }`}>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="text-sm font-semibold text-red-700 mb-1">Flag Reason:</div>
                <p className="text-red-600">{attempt.flagReason || 'No reason provided'}</p>
              </div>
